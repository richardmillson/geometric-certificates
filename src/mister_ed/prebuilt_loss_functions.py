...
class VanillaXentropy(lf.RegularizedLoss):
    ...
    def __init__(self, classifier, normalizer=None):
        partial_xentropy = lf.PartialXentropy(classifier,
...
class PerceptualXentropy(lf.RegularizedLoss):
    ...
    def __init__(self,
        ...
        super(PerceptualXentropy, self).__init__(
            {
                'xentropy': partial_xentropy,
                'lpips_reg': lpips_reg
            }, {
                'xentropy': 1.0,
                'lpips_reg': regularization_constant
            })
...
class CWL2Loss(lf.RegularizedLoss):
    ...
    def __init__(self, classifier, normalizer, kappa=0.0):
        ...
        # build F6 component
        f6_component = lf.CWLossF6(classifier,
                                   normalizer=normalizer,
                                   kappa=kappa)
    ...
    def forward(self, examples, labels, scale_constant=None, targeted=False):
        ...
        return super(CWL2Loss, self).forward(examples,
                                             labels,
                                             targeted=targeted)
...
class CWLInfLoss(lf.RegularizedLoss):
    ...
    def forward(self, examples, labels, scale_constant=None, targeted=False):
        ...
        return super(CWLInfLoss, self).forward(examples,
                                               labels,
                                               targeted=targeted)
...
class CWLpipsLoss(lf.RegularizedLoss):
    ...
    def forward(self, examples, labels, scale_constant=None, targeted=False):
        ...
        return super(CWLpipsLoss, self).forward(examples,
                                                labels,
                                                targeted=targeted)
...
class CWTransformerLoss(lf.RegularizedLoss):
    ...
    def __init__(self,
                 classifier,
                 normalizer,
                 transformation_scalar,
                 kappa=0.0):
        # build f6 component
        f6_component = lf.CWLossF6(classifier, normalizer, kappa=kappa)

        # build transformation loss
        transform_reg = lf.CombinedTransformerLoss(
            None, transform_class=st.FullSpatial, regularization_constant=1.0)

        super(CWTransformerLoss, self).__init__(
            {
                'f6': f6_component,
    ...
    def forward(self, examples, labels, scale_constant=None, targeted=False):
        ...
        return super(CWTransformerLoss, self).forward(examples,
                                                      labels,
                                                      targeted=targeted)
...
class CWRelaxedTransformerLoss(lf.RegularizedLoss):
    ...
    def forward(self, examples, labels, scale_constant=None, targeted=False):
        ...
        return super(RelaxedTransformerLoss, self).forward(examples,
                                                           labels,
                                                           targeted=targeted)
