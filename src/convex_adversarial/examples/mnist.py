    ...
    for _ in range(0, args.cascade):
        ...
        for t in range(args.epochs):
            ...
            # madry training
                ...
                train_madry(train_loader, model[0], args.epsilon, opt, t,
                            train_log, args.verbose)
                err = evaluate_madry(test_loader, model[0], args.epsilon, t,
                                     test_log, args.verbose)

            # robust cascade training
            elif args.cascade > 1:
                train_robust(train_loader,
                             model[-1],
                             opt,
                             epsilon,
                             t,
                             ...
                             args.verbose,
                             args.real_time,
                             norm_type=args.norm_train,
                             bounded_input=True,
                             **kwargs)
                err = evaluate_robust_cascade(test_loader,
                                              model,
                                              args.epsilon,
                                              t,
                                              test_log,
            ...
            # robust training
                ...
                train_robust(train_loader,
                             ...
                             bounded_input=True,
                             **kwargs)
                err = evaluate_robust(test_loader,
                                      model[0],
                                      args.epsilon,
                                      t,
                                      test_log,
