...
from .inceptionresnetv2 import \
    pretrained_settings as inceptionresnetv2_settings
...
from .torchvision_models import \
    pretrained_settings as torchvision_models_settings
from .xception import pretrained_settings as xception_settings

all_settings = [
    fbresnet_settings, bninception_settings, resnext_settings,
    inceptionv4_settings, inceptionresnetv2_settings,
    torchvision_models_settings, nasnet_mobile_settings, nasnet_settings,
    dpn_settings, xception_settings, senet_settings
]
