...
def build_delta_stadv_pgd(model,
                          normalizer,
                          delta_bound=L_INF_BOUND,
...
def build_delta_stadv_rot_trans_pgd(model,
                                    normalizer,
                                    delta_bound=L_INF_BOUND,
                                    flow_bound=FLOW_LINF,
                                    trans_bound=TRANS_LINF,
    ...
    sequence_threat = ap.ThreatModel(
        ...
        ap.PerturbationParameters(norm_weights=[0.00, 1.00, 1.0, 1.0]))
