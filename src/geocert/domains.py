...
class Domain(object):
    ...
    def from_dict(cls, saved_dict):
        ...
        for s in [
                'box_low', 'box_high', 'l2_radius', 'linf_radius',
    ...
    def set_original_hyperbox_bound(self, lo, hi):
        ...
        self.unmodified_bounds_high = np.ones(self.dimension, dtype=bool)
        self.unmodified_bounds_low = np.ones(self.dimension, dtype=bool)
    ...
    def current_upper_bound(self, lp_norm):
        ...
        return {'l_2': self.l2_radius, 'l_inf': self.linf_radius}[lp_norm]
    ...
    def _compute_new_lohi(self, lo_or_hi, vals):
        ...
        assert isinstance(vals,
                          np.ndarray) and vals.shape == (self.dimension, )
    ...
    def _compute_linf_radius(self):
        ...
        linf_radius = max([
            np.abs(self.box_high - self.x).max(),
